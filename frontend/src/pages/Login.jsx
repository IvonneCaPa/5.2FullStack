...
import Header, { HeaderLogoOnly } from '../components/Header';
...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-orange-100 to-orange-200 overflow-hidden">
      <HeaderLogoOnly />
